...
namespace AssemblyCSharp
{
	...
	{
		private const string BehaviorID = "B02";
		...
		public CBInsRegMemberController (InputParams p, string ServerAddress, Action<string, WWW> callback_success, Action<string, WWW> callback_error)
			:base(ServerAddress, callback_success, callback_error)
		{
			this.ServerAddress = ServerAddress;
			var path = "api/CBInsRegMember";
